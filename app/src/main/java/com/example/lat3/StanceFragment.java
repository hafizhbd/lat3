 ...
 */
public class StanceFragment extends Fragment {
    private Button back;

    public StanceFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_stance, container, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                getFragmentManager().beginTransaction().replace(R.id.main_frame, galleryFragment)
                        .addToBackStack(null)
